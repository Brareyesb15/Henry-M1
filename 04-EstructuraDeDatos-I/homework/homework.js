...
Queue.prototype.enqueue = function(a) {
 ...
 Queue.prototype.dequeue = function () {
   if (this.array_s.length === 0) return undefined;
   else return this.array_s.shift() /* en este punto creo que el test está raro porque te pide retorno al shift cuando 
    no es necesario (quizá solo para saber que estás sacando en el orden correcto) y tampoco te lo pide el test. */
}
Queue.prototype.size = function () {
   return this.array_s.length
}
